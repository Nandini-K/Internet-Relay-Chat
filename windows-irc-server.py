...
####################################################################################################
#	
#	This code is written for Windows OS client and server, and doesn't support secure messaging. 
#	Secure messaging is supported only on Linux. To run this code on Linux, un-comment the 
#	commented lines of code. If a Windows specific code line performing the same action is present  
#	in previous line, comment that instead.
# 
####################################################################################################
